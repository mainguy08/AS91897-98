...
class UserDetails:
    ...
    def nameCheck(self, name):
        ...
        if len(name) == 13:
            ...
            mb.showerror("Error", "The name you entered is invalid. Name should only contain alphabet letter. Please try again.")
            return False
        return
    ...
    def ageCheck(self, age):
        while True:
            try:
                ...
                mb.showerror("Error", "Age should be entered as number. Please try again.")
                return False
                break
        return
        ...
        while True:
            try:
                ...
                if year_level >= 9 and year_level <= 13:
                    ...
                    mb.showerror("Error", "The year level you entered is invalid. Year level should be between 9 and 13. Please try again.")
                    return False
                    break
            except ValueError:
                mb.showerror("Error", "Please enter a number in year level. Please try again.")
                return False
                break
        return
